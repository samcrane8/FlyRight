...
export default {
  ...
  methods: {
    ...
    async logout(token) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/o/revoke_token/'
      var data = { 'grant_type': 'password',
        client_id: process.env.CLIENT_ID,
        client_secret: process.env.CLIENT_SECRET,
        token
    ...
    async register_pilot(email, password, username,
      ...
      var body = {email, password, username,
        ...
        first_name, last_name}
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/pilot/register/'
      return await axios.post(url,body);
    },
    async get_user_info(token, id) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/user/get/?id='+id
      return await axios.get(url, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async get_pilot_info(token, id) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/pilot/get/?id='+id
      return await axios.get(url, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async get_current_user_info(token) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/user/get_current/'
      return await axios.get(url, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async update_user_info(user_info, token) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/user/update/'
      return await axios.post(url,user_info, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async update_pilot_info(pilot_info, token) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/pilot/update/'
      return await axios.post(url,pilot_info, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async forgot_password(email) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/user/forgot_password/?email='+email
      return await axios.get(url);
    },
    async change_password(old_password, new_password, token) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/user/change_password/'
    ...
    async edit_drone_details(drone, token) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/drone/edit_drone_details/'
    ...
    async register_mission(title, area, description, starts_at, ends_at, type, token) {
      ...
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/register/'
      return await axios.post(url,body,{
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async get_mission_drones(mission_id, token) {
      ...
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/get_drones/'
      return await axios.post(url,body, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async get_mission_info(mission_id, token){
      var body = {'mission_id': mission_id}
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/get_info/'
      return await axios.post(url, body, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async add_drone_to_mission(drone_id, mission_id, operator_id, token) {
      ...
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/add_drone/'
      return await axios.post(url,body, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async remove_drone_from_mission(drone_id, mission_id, token) {
      ...
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/remove_drone/'
      return await axios.post(url,body, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async get_missions(token){
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/get/'
      return await axios.get(url, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    ...
    async delete_mission(mission_id, token) {
      var body = {'mission_id': mission_id}
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/delete/'
      return await axios.post(url,body, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async get_current_missions(token){
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/get_current/'
      return await axios.get(url, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async get_past_missions(token){
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/get_past/'
      return await axios.get(url, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    async get_upcoming_missions(token){
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/get_upcoming/'
      return await axios.get(url, {
        headers: {'Authorization': 'Bearer '+token}
      });
    },
    ...
    async edit_mission_details(details, token) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/edit/'
      return await axios.post(url,details, {
        headers: {'Authorization': 'Bearer '+token}
      });
    },
    async edit_clearance(mission_id,new_clearance_state, message, token) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/flight/edit_clearance/'
    ...
    async is_government_official(token) {
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/department/is_government_official/'
      return await axios.get(url, {
        headers: {'Authorization': 'Bearer ' + token}
      });
    },
    ...
    async flight_histogram(department_id, start_day, end_day, token){
      ...
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/department/flight_histogram/'
      return await axios.post(url,body, {
        headers: {'Authorization': 'Bearer '+token}
      });
    },
    async message_pilots(message, department_name, token){
      ...
      var url = process.env.VUE_APP_BUSINESS_LOGIC_HOST + '/department/message_jurisdiction/'
      return await axios.post(url,body, {
        headers: {'Authorization': 'Bearer '+token}
      });
    },
